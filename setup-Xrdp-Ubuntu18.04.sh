...
#---------------------------------------------------#
# Script Version information Displayed  2.3             #
#---------------------------------------------------#

echo
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
/bin/echo -e "\e[1;36m   !   Standard XRDP Installation Script  - Ver 2.3 ล่าสุดให้หน้าหี        !\e[0m"
...
/bin/echo -e "\e[1;36m ! Written by SCK 2019 - Ver 2.3 - setup-Xrdp-Ubuntu18.04.sh   !\e[0m"
/bin/echo -e "\e[1;36m !-----------------------------------------------------------------------!\e[0m"
echo
...
echo
/bin/echo -e "\e[1;36m   !-------------------------------------------------------------!\e[0m"
/bin/echo -e "\e[1;46m  |-------ติดตั้งเสร็จแล้วก็ติดตามกูด้วย---------------|\e[0m"
/bin/echo -e "\e[1;45m   !   Written by SCK - 1/10/2019 - check-th.tk        !\e[0m"
/bin/echo -e "\e[1;58m   !--------[หากมีปัณหาติดต่อ FB:ยลยุทธ วันชาติ]-----------------------------!\e[0m"
